...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-white pt-16">
        ...
        <div className="max-w-6xl mx-auto px-5 py-3.5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
              <Image src="/logo.png" alt="DNounce Logo" width={36} height={36} priority />
      ...
      {/* ── Scroll Progress Bar ─────────────────────────────────────────────── */}
      <div className="fixed left-0 w-full h-[2px] bg-transparent" style={{ top: "4.2rem", zIndex: 60, position: "fixed" }}>
      ...
      <section className="pt-24 pb-20 px-5">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-gray-900 leading-[1.05] tracking-tight mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-violet-600">the whole story.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button
              onClick={() => document.getElementById("submit-record-section")?.scrollIntoView({ behavior: "smooth" })}
              className="inline-flex items-center justify-center gap-2 bg-white border border-gray-200 hover:border-gray-300 text-gray-800 font-semibold px-7 py-3.5 rounded-2xl transition-all text-sm"
            >
              Share Experience
            </button>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-500">
                {["Terms of Service","Privacy Policy","Transparency Report","Legal Framework"].map((item) => (
                  <li key={item}><a href="#" className="hover:text-white transition-colors">{item}</a></li>
                ))}
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-500">
                {["Help Center","Contact Support","Appeal Process","Status Page"].map((item) => (
                  <li key={item}><a href="#" className="hover:text-white transition-colors">{item}</a></li>
                ))}
              </ul>
            </div>

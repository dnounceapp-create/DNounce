...
const SCORES = { subject_score: 3.2, overall_score: 61 };
...
const RECORDS = [
  {
    ...
    description:
      "I felt pressured by my realtor to make an offer on a property I wasn't fully comfortable with. Every time I expressed hesitation, the response was about how fast the market was moving and how I'd lose it if I waited...",
    date: "04/02/2026",
    comments: 7,
  },
];

const DEMO_RECORD_HREF = "/demo/realtor";

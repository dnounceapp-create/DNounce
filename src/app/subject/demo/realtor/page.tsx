...
const SUBJECT = {
  ...
  job_title: "Licensed Realtor",
  organization: "Palmview Realty Group",
  location: "Miami, FL",
  bio: "Serving buyers and sellers in South Florida for over 8 years. Specializing in residential real estate in Miami-Dade and Broward counties.",
  subject_uuid: "demo-realtor-john-doe",
};

const SCORES = {
  subject_score: 3.2 as number | null,
  overall_score: 61 as number | null,
...
const RECORDS = [
  {
    ...
    title: "Simone A. • John Doe",
    category: "Realtor",
    stage: "Voting Open",
    anonymity_status: "Anonymity Not Granted",
    description:
      "I felt pressured by my realtor to make an offer on a property I wasn't fully comfortable with. Every time I expressed hesitation, the response was about how fast the market was moving and how I'd lose it if I waited. I ultimately made an offer I regretted.",
    date: "2026-04-02T19:57:12.655Z",
    comments: 7,
  },
];

const QR_URL = "https://www.dnounce.com/subject/demo/realtor";
const RECORD_HREF = "/demo/realtor";
  ...
  useEffect(() => {
    supabase.auth.getSession().then(async ({ data: sessionData }) => {
      ...
      supabase
        .from("page_views")
        .insert({
          page_type: "demo_subject_realtor",
          page_id: null,

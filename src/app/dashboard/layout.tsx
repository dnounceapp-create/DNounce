        ...
        <main className="overflow-y-auto relative">
          ...
          <div ref={tickerRef} className="border-t border-gray-100 bg-white py-6 px-4 sm:px-6 space-y-6">
            ...
            {trendingRecords.length > 0 && (
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-semibold text-gray-900">Top 5 records trending today</span>
            ...
            {topVoters.length > 0 && (
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-semibold text-gray-900">Top 5 voters today</span>
            ...
            {worstVoters.length > 0 && (
              <div>
                <div className="flex items-center justify-between mb-2">
                  <span className="text-xs font-semibold text-gray-900">Worst 5 voters today</span>

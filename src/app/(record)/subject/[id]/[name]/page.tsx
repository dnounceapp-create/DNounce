  ...
  if (claimState === "not-logged-in") {
    return (
      <div className="mb-6 rounded-2xl border border-gray-200 bg-gray-50 p-4 flex items-center justify-between gap-3">
        ...
        <button
          onClick={() => router.push(`/loginsignup?redirectTo=${encodeURIComponent(typeof window !== "undefined" ? window.location.pathname : `/subject/${subjectId}`)}`)}
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
              ...
              <div className="flex flex-col">
                ...
                {ownerBio && (
                  <p className="text-sm text-gray-600 mt-3 leading-relaxed">{ownerBio}</p>
                )}

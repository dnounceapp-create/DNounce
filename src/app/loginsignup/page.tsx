...
export default function LoginSignupPage() {
  ...
  // Derived — is the login/signup email a Gmail?
  const loginIsGmail = isValidEmail(loginEmail) && isGoogleEmail(loginEmail);
  const signupIsGmail = isValidEmail(signupEmail) && isGoogleEmail(signupEmail);
  ...
  useEffect(() => {
    const checkSession = async () => {
      ...
      if (!isOnboarded) { router.replace("/user-setup"); return; }
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (res.error) {
      ...
      if (msg.includes("already registered") || msg.includes("user already exists")) {
        ...
        setSignupError("This email already has an account. The password you entered is incorrect — try logging in instead.");
      } else {
            ...
            <div className="w-full bg-white shadow-md rounded-xl p-6 sm:p-8">
              ...
              {mfaRequired ? (
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  {/* Only show password field for non-Gmail */}
                  {!loginIsGmail && (
                    <input
                      type="password"
                  ...
                  {loginIsGmail && (
                    <p className="text-sm text-blue-600 text-center">
                      This is a Google account — use "Continue with Google" below.
                    </p>
                  )}
                  ...
                  {/* Show login button for non-Gmail, Google button for Gmail */}
                  {loginIsGmail ? (
                    <button
                      type="button"
                  ...
                  {/* Always show Google button at bottom for non-Gmail too */}
                  {!loginIsGmail && (
                    <div className="mt-2">
                      <button
                        type="button"
              ...
              {showEmailSent ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSignup} className="space-y-4">
                    ...
                    {signupIsGmail && (
                      <p className="text-sm text-blue-600 text-center">
                        This is a Google account — use "Sign up with Google" below.
                      </p>
                    )}
                    ...
                    {/* Show create account button for non-Gmail, Google button for Gmail */}
                    {signupIsGmail ? (
                      <button
                        type="button"
                        onClick={handleGoogle}
